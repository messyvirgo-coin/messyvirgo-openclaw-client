...
info "Or: export OPENCLAW_CONFIG_PATH=$dest OPENCLAW_STATE_DIR=$OPENCLAW_CONFIG_DIR"
info "    (and other vars from .env) then run: openclaw gateway --port ${OPENCLAW_GATEWAY_PORT:-18789}"
echo ""
