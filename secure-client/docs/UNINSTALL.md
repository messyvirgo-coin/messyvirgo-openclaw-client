...
```bash
./secure-client/scripts/reset.sh --delete-config --delete-src --delete-workspace --remove-image --yes
```
...
```bash
./secure-client/scripts/reset.sh --delete-config --delete-src --remove-image --yes
```
...
```bash
./secure-client/scripts/reset.sh --system-prune --yes
```
